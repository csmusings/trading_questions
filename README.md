To build the executables just run make from command line. Quesiton1 uses dynamic programming table, question2 uses a mathematical simulation on multiple threads.
